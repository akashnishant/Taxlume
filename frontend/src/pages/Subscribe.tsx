              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full rounded-lg bg-lime-300 py-3 text-sm font-semibold text-slate-950 transition hover:bg-lime-200 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {isStartingPayment ? (
