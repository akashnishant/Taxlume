...
const SalesRegisterQuery = z.object({
  start_date: z
    .string()
...
export class ReportSalesRegister extends OpenAPIRoute {
  schema = {
    tags: ["Reports"],
    summary: "Get issued tax invoice sales register",
    request: {
      query: SalesRegisterQuery,
    },
    responses: {
      "200": {
        description: "Sales register retrieved successfully",
      },
      "400": {
